...
const menuItems = [
  ...
  {
    id: 'tables',
    label: 'Tablas / Errores',
    to: '/tables-errors',
    icon: Table2,
    children: [
      { label: 'Errores Léxicos', to: '/tables-errors?type=lexical' },
      { label: 'Errores Sintácticos', to: '/tables-errors?type=syntax' },
      { label: 'Errores Semánticos', to: '/tables-errors?type=semantic' },
    ],
  },
]
