...
const outputTabs = ['Output', 'Documentation', 'Errors']
  ...
  return (
    <section className="h-full px-8 py-8 lg:px-10">
      <div className="mb-8 flex flex-wrap items-center justify-between gap-4">
        <div>
          <h1 className="text-4xl font-medium text-slate-900">Playground</h1>
          <p className="mt-3 max-w-3xl text-lg leading-8 text-slate-600">
            Test your source code in a split view layout. Use the left panel to edit code and the right panel to inspect the output, documentation, or error tables.
          </p>
        </div>
          ...
          <div className="main-scrollbar flex-1 overflow-y-auto p-6">
            ...
            {tab === 'Documentation' ? (
              <div className="space-y-5 rounded-2xl border border-slate-200 bg-slate-50 p-6 text-slate-700">
                <h3 className="text-2xl font-medium text-slate-900">Quick Reference</h3>
                <p className="text-base leading-7">
                  Use this panel to surface documentation while the editor remains visible, following the exact behavior you requested for the 50/50 playground layout.
                </p>
                <ul className="space-y-3 text-base leading-7">
                  <li>• See the expected transpiler options.</li>
                  <li>• Open examples without leaving the editor.</li>
                  <li>• Keep documentation and code side by side.</li>
                </ul>
              </div>
            ) : null}
                ...
                <table className="min-w-full divide-y divide-slate-200 text-left">
                  ...
                  <tbody className="divide-y divide-slate-200 bg-white text-sm text-slate-700">
                    <tr>
                      ...
                      <td className="px-4 py-3">Missing semicolon</td>
                      <td className="px-4 py-3">18</td>
                    </tr>
                    <tr>
                      <td className="px-4 py-3">SEM002</td>
                      <td className="px-4 py-3">Type mismatch</td>
